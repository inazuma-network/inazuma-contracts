...
This repository holds WASM contract examples and tooling. Contributions are welcome, including your first one.
...
## Setting up
        ...
        ```bash
        git clone https://github.com/inazuma-network/inazuma-contracts.git
        cd inazuma-contracts
